...
namespace CiWong.Framework.Captcha
{
	...
	public class CaptchaImage
	{
        ...
        public static CaptchaImage CreateCaptcha(string guid)
        {
            ...
            HttpContext.Current.Response.Cookies.Add(verifysession);
            return captch;
        }
        ...
        private static readonly Color[] RandomColor = { 
                                                          Color.FromArgb(0,101,81),
                                                          Color.FromArgb(66,61,57),
                                                          Color.FromArgb(68,9,41),
                                                          Color.FromArgb(60,35,138),
                                                          Color.FromArgb(202,25,46),
                                                          Color.Green, 
                                                          Color.FromArgb(25,80,202), 
                                                          Color.Black, 
                                                          Color.Purple, 
                                                          Color.Orange
                                                      };
		...
		{
            Bitmap bmp = new Bitmap(_width, _height, PixelFormat.Format32bppRgb);
